      ...
      <div class="overflow-x-auto">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4 text-sm">{{ (item.expenseDate as string).split('T')[0] }}</td>
            <td class="px-6 py-4 text-sm">{{ item.name }}</td>
            <td class="px-6 py-4 text-sm text-right font-medium text-destructive">-Rp {{ item.amount.toLocaleString() }}</td>
